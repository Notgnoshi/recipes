...
\begin{recipe}{French Meat Pie}{serves 6}{375\0}
    \ingredient[1]{lb}{Ground beef}
    \ingredient[1]{lb}{Ground sausage}
    Brown and drain beef and sausage.

    \ingredient[1]{cup}{Mashed potatoes}
    \ingredient[2]{tsp}{Allspice}
    \ingredient[1]{tsp}{Salt}
...
\begin{recipe}{Tamale Pie}{Serves 8}{400\0}
    \ingredient[1]{box}{corn muffin mix}
    \ingredient[1]{}{egg}
    \ingredient[$\frac{1}{2}$]{cup}{sour cream}
    \ingredient[$\frac{1}{2}$]{cup}{canned cream corn}
    ...
    \ingredient[$\frac{1}{3}$]{cup}{red enchilada sauce}
    \ingredient[1]{cup}{shredded cheddar}
    \ingredient[1]{cup}{shredded monterey jack}
...
\begin{recipe}{Enchilada Sloppy Joe Pie}{Serves 4}{400\0}
    ...
    \ingredient[1]{4 oz can}{chopped green chiles}
    \ingredient[1]{10 oz can}{green enchilada sauce}
    \ingredient[$1\frac{1}{2}$]{cups}{shredded cheddar}
    Stir in green chiles and enchilada sauce. Top with cheese.

    \ingredient[1]{cup}{Bisquick mix}
